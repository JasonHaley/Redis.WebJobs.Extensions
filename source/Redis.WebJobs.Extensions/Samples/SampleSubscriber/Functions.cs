...
namespace SampleSubscriber
{
    ...
    {
        //public static void ReceiveSimpleMessage([RedisTrigger("messages")] string message)
        //{
        ...
        //public static void ReceiveMessage([RedisTrigger("messages")] Message message, TextWriter log)
        //{
        //    string outMessage;
        //    if (message != null)
        //    {
