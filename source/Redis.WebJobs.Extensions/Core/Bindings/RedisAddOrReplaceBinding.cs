...
{
    internal class RedisAddOrReplaceBinding : IBinding
    {
        private readonly string _parameterName;
        private readonly IArgumentBinding<RedisKeyEntity> _argumentBinding;
        private readonly RedisAccount _account;
        private readonly string _keyName;
        public RedisAddOrReplaceBinding(string parameterName, IArgumentBinding<RedisKeyEntity> argumentBinding, RedisAccount account, string keyName)
        {
        ...
        {
            return new RedisAddOrReplaceBinding.RedisKeyParameterDescriptor
            {
                Name = _parameterName,
                KeyName = _keyName,
